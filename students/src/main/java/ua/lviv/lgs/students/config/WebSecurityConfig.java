package ua.lviv.lgs.students.config;
...
import ua.lviv.lgs.students.security.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/home").access("hasRole('ROLE_STUDENT')  or hasRole('ROLE_STUDENT')")
		.antMatchers("/buckets").access("hasRole('ROLE_STUDENT')")
